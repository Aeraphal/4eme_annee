...
%% matGamma_3D     matrice Gamma de différentiation d'ordre 1 ou 2 en 3D
%       G = matGamma_3D(COORDS,FACES,TYPE)  crée la matrice de dérivation 
%       de type TYPE adaptée au maillage (XYZ,FACES)
%       . COORDS    matrice Nx3 dont la i-ème ligne correspond au vecteur
%                   de coordonnées (X,Y,Z) du i-ème point du maillage
%       . FACES     matrice Nx3 dont la i-ème ligne donne les  numéros des
